...
Polluting globals is a bad practice in many languages because you could clash with another library, and the user of your library would be none-the-wiser until they get an exception in production. Let's think about an example: what if you wanted to hace a configuration array? You could write a global function like `config()`, but it could clash with another library that tried to do the same thing.
